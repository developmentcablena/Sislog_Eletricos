            ...
            <ContentTemplate>
                ...
                <div class="div__header">
                    ...
                    <nav class="nav__button">
                        ...
                        <uc7:Motivo runat="server" />
                    
                    </nav>
                    <asp:ImageButton ID="btnPerfil" runat="server" ImageUrl="~/Images/avatar_profile.svg" CssClass="btn-avatar" OnClientClick="abrirModalSair(); return false;" />
                    <uc8:Sair runat="server" />
                </div>
